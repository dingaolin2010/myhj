 ...
 */
package com.csair.wxopen.core.generate;

import com.csair.wxopen.core.utils.DateUtils;
import com.csair.wxopen.core.utils.FileUtils;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.csair.wxopen";
		
		String moduleName = "internal";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "user";			// 类名，例：user
		String classAuthor = "kelvin";		// 类作者，例：ThinkGem
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/csair/wxopen/core/generate/", "/", separator);
