...
import com.csair.wxopen.core.utils.Exceptions;
import com.csair.wxopen.core.utils.Reflections;
...
public class JaxbMapper {
   private JaxbMapper()
   {
	 ...
	 * XML -> Java List
	 */
	public static  <T> List fromXmlToList( String xmlLocation,Class<T> topLevelClass) {
		JAXBContext jc = null;
		try {
			jc = JAXBContext.newInstance(Wrapper.class,topLevelClass);
			// Unmarshal
			Unmarshaller unmarshaller = jc.createUnmarshaller();
			return unmarshal(unmarshaller, topLevelClass, xmlLocation);
		} catch (JAXBException e) {
			throw Exceptions.unchecked(e);
		}
	}
