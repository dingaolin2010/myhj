...
public class SpellHelper {
    ...
    public static String toNickName(String str)throws Exception{
        String names=getUpEname(str);
        String[] nicks=names.split(" ");
        String allName=nicks[0].toUpperCase();
        String nickName=allName.substring(0,2);
        return nickName;
    }

    public static void main(String[] args) throws Exception{
        System.out.println(toNickName("王大大"));
    }
}
